 ...
 */
  ...
  getEventProperties(event) {
    ...
    else if (util.hasParent(element, this.itemSet.dom.ungrouped))        {what = 'ungrouped-area';}
    else if (util.hasParent(element, this.itemSet.dom.ungroupedHeader))  {what = 'ungrouped-area-header';}
