...
import { Validator, printStyle } from "../shared/Validator.js";
import util, { isDataViewLike, typeCoerceDataSet } from "../util.js";
...
export default class Timeline extends Core {
  ...
  getEventProperties(event) {
    ...
    if (item != null) {
      ...
      what = "current-time";
    } else if (util.hasParent(element, this.itemSet.dom.ungrouped)) {
      what = "ungrouped-area";
    } else if (util.hasParent(element, this.itemSet.dom.ungroupedHeader)) {
